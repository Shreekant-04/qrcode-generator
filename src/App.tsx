...
import { Download, Upload, Palette, Settings, Layers, FileText, Camera } from 'lucide-react';
          ...
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Advanced QR Code Generator</p>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Higher levels allow more logo coverage but create larger codes
                  </p>
                </div>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white rounded-2xl shadow-2xl p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Your customized QR code will appear below</p>
              </div>
